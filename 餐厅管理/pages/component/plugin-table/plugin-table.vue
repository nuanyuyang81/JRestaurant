			...
			<view class="z-table-container">
				<view class="z-table-pack">
					<view class="z-table-title">
						<view class="z-table-title-item" :class="{ 'z-table-stick-side': stickSide && (index == 0 || index ==1) }" :style="{ width: item.width ? item.width + 'rpx' : '200rpx' }"
					...
					<view v-if="tableData.length" :class="['table-container-box', {'short-table': !longTable && showBottomSum}]">
						<view class="z-table-container-row" :class="{ 'z-table-has-bottom': showBottomSum }" v-for="(row, iIndex) in tableData"
						 :key="iIndex">
							<view :class="['z-table-container-col', { 'z-table-stick-side z-table-stick-side-color': stickSide && (jIndex == 0 || jIndex == 1) }]"
					...
					<view :class="['z-table-bottom', {'long-table': longTable}]" v-if="showBottomSum && tableData.length">
						<view class="z-table-bottom-col" :class="{ 'z-table-stick-side-color z-table-stick-side': stickSide && (sumIndex == 0 || sumIndex == 1) }"
